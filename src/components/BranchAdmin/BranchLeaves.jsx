  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow p-6">
        ...
        <p className="text-gray-600 mt-1">Approve or reject leave requests from barbers in your branch</p>
      </div>
              ...
              {filteredLeaves.map((leave) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className={`flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold border ${getStatusColor(leave.status)}`}>
