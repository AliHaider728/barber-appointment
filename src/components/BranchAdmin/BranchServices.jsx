  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        ...
        <p className="text-gray-600 text-sm mt-1">View available services at your branch</p>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-blue-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{maleServices.length}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-pink-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{femaleServices.length}</p>
            </div>
