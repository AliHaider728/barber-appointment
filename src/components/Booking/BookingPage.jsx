                  ...
                  <>
                    {!stripePromise ? (
                      <div className="bg-red-50 border-2 border-red-200 rounded-lg p-4 mt-4">
                        <p className="text-red-700 text-sm font-bold">⚠️ Card payment is temporarily unavailable</p>
                        <p className="text-red-600 text-xs mt-1">Please select "Pay at Salon" or contact support</p>
                      </div>
                    ) : (
