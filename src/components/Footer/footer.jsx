  ...
  <>
   <div className="max-w-full  ">
    ...
    `}
      ...
      {/* Main Footer Content */}
      <div className="absolute top-[40.3%] md:h-96 h-fit left-1/2 -translate-x-1/2  w-[90%]  bg-[rgba(10,10,10,0.95)] rounded-2xl border-2 border-[#D4AF37] shadow-[0_0_30px_rgba(212,175,55,0.4),_inset_0_0_20px_rgba(212,175,55,0.1)] z-[6] backdrop-blur-lg p-16 bottom-0 ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <NavLink to="/booking"
                ...
                className=" bg-[#D4AF37] text-black px-5 py-2 text-[11px] font-bold uppercase tracking-wider rounded-sm border-none cursor-pointer transition-all duration-300 hover:bg-white hover:-translate-y-[2px]"
              >
                Book Now
              </NavLink>
            </div>
            ...
            {/* Appointment Hours */}
            <div className="-ml-5 relative md:-left-16">
              <h4 className="text-base font-bold uppercase mb-4 text-white">
                Appointment Hours
              </h4>
